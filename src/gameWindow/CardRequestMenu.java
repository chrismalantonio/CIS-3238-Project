 ...
 * @author Neel Patel
 */
public class CardRequestMenu extends javax.swing.JFrame {
...
//        this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardRequestMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
